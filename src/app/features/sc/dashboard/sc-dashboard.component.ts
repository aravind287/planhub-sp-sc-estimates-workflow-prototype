...
@Component({
  ...
  template: `
    <div class="bid-board-wrap">
      ...
      <div class="stats-row">
        <div class="stat-card">
          <div class="stat-icon-wrap" style="background:#ebf8ff;">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#3182ce" stroke-width="2">
        ...
        <div class="stat-card">
          <div class="stat-icon-wrap" style="background:#faf5ff;">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#805ad5" stroke-width="2">
          ...
          <div class="stat-content">
            ...
            <div class="stat-label">Estimates Received</div>
          </div>
        </div>
        <div class="stat-card">
          <div class="stat-icon-wrap" style="background:#fffaf0;">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#c05621" stroke-width="2">
          ...
          <div class="stat-content">
            ...
            <div class="stat-label">Awaiting Comparison</div>
          </div>
        </div>
        <div class="stat-card">
          <div class="stat-icon-wrap" style="background:#f0fff4;">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#276749" stroke-width="2">
      ...
      <div class="filter-row">
        ...
        <select class="ph-select" [(ngModel)]="statusFilter" (change)="filterProjects()">
